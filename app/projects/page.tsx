  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 pt-32 pb-16">
        <BackLink />
        <h1 className="font-mono text-4xl md:text-5xl font-bold mb-12">{t.projects.title}</h1>

        <div className="space-y-8">
          {projects.map((project) => (
            <div key={project.id} className="glass rounded-lg overflow-hidden hover:shadow-xl transition-shadow">
              <div className="flex flex-col md:flex-row">
                ...
                <div className="flex-1 p-6 flex flex-col justify-between">
                  {/* Title */}
                  <h2 className="font-mono text-2xl font-bold mb-3">{project.title}</h2>
                  ...
                  <div className="flex gap-3">
                    <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="cursor-pointer">
                      <Button variant="outline" className="gap-2 hover:bg-accent/20 bg-transparent cursor-pointer">
